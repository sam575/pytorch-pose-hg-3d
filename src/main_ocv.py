...
def main():
  ...
  for epoch in range(1, opt.nEpochs + 1):
    loss_train, acc_train, acc_ocv_train, loss_ocv_train = train(epoch, opt, train_loader, model, criterion, optimizer)
    ...
    if epoch % opt.valIntervals == 0:
      loss_val, acc_val, acc_ocv_val, loss_ocv_val = val(epoch, opt, val_loader, model, criterion)
      ...
      logger.write('{:8f} {:8f} {:8f} {:8f} {:8f} {:8f} {:8f} {:8f} \n'.format(loss_train, acc_train, acc_ocv_train, loss_ocv_train, loss_val, acc_val, acc_ocv_val, loss_ocv_val))
    else:
      logger.write('{:8f} {:8f} {:8f} {:8f} \n'.format(loss_train, acc_train, acc_ocv_train, loss_ocv_train))
